 ...
 <div class="timeline-track flat">
  ...
  <div class="timeline-item is-up">
    <div class="timeline-card">
      ...
      <span class="entry-org">Hindustan Unilever</span>
    </div>
    <div class="timeline-node">
      <span class="timeline-dot"></span>
...
<h2 id="pm-case-studies">PM Case Studies</h2>
<p class="lede" style="margin-bottom:1.75rem;">A closer look at three initiatives from the Hero Fincorp role — problem, approach, and outcome.</p>
...
<div class="case-study">
  ...
  <div class="case-study-grid">
    <div>
      <span class="case-study-label">Problem</span>
      <p>Growth was concentrated in one lending line, with limited organic acquisition and an underserved segment nobody had sized.</p>
    </div>
    <div>
      <span class="case-study-label">Approach</span>
...
<div class="case-study">
  ...
  <div class="case-study-grid">
    ...
    <div>
      <span class="case-study-label">Approach</span>
      <p>Delivered a CRM-integrated LLM agent for query resolution and built LLM-powered recruitment agents; in parallel, scoped a financial copilot for contextual recommendations.</p>
    </div>
    <div>
      <span class="case-study-label">Impact</span>
